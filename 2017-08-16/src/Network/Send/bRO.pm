...
sub new {
	...
	my %packets = (
		...
		'0860' => ['item_drop', 'a2 v', [qw(ID amount)]],
		'093C' => ['storage_item_add', 'a2 V', [qw(ID amount)]],
		...
		'0925' => ['party_join_request_by_name', 'Z24', [qw(partyName)]], #f
	...
	$self->cryptKeys(2041138947, 952071351, 1050549552);
