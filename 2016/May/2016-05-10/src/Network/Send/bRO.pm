...
sub new {
	...
	my %packets = (
		...
		'0940' => ['storage_item_add', 'v V', [qw(index amount)]],
		...
		'0965' => ['homunculus_command', 'v C', [qw(commandType, commandID)]], #f
		'0885' => ['storage_password'],
	);
	...
	$self->cryptKeys(1044120939, 1075061420, 1393841778);
