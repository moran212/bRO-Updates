...
sub new {
	...
	my %packets = (
		'0952' => ['actor_action', 'a4 C', [qw(targetID type)]],
		'0927' => ['skill_use', 'v2 a4', [qw(lv skillID targetID)]],
		'095B' => ['character_move','a3', [qw(coords)]],
		'093A' => ['sync', 'V', [qw(time)]],
		...
		'0883' => ['storage_item_remove', 'v V', [qw(index amount)]],
		'0815' => ['skill_use_location', 'v4', [qw(lv skillID x y)]],
		'0436' => ['actor_info_request', 'a4', [qw(ID)]],
		'0876' => ['actor_name_request', 'a4', [qw(ID)]],
		'07E4' => ['item_list_res', 'v V2 a*', [qw(len type action itemInfo)]],
		'0935' => ['map_login', 'a4 a4 a4 V C', [qw(accountID charID sessionID tick sex)]],
		'0202' => ['party_join_request_by_name', 'Z24', [qw(partyName)]], #f
	...
	$self->cryptKeys(1992653268, 2066693446, 1020615157);
